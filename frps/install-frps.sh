...
program_version_link="https://raw.githubusercontent.com/NeoVilsonWong/frps/master/frps/version.sh"
str_install_shell=https://raw.githubusercontent.com/NeoVilsonWong/frps/master/frps/install-frps.sh
shell_update(){
    fun_clangcn "clear"
